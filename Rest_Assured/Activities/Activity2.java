...
public class Activity2 {
	...
	public void addNewUserFromFile() throws IOException {
		// Import JSON file
		FileInputStream inputJSON = new FileInputStream("/restassured/src/main/resources/userInfo.json");
	...
	public void getUserInfo() {
		...
		File outputJSON = new File("restassured/src/main/resources/userGETResponse.json");
