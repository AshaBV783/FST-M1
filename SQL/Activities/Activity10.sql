...
Write a query to find all the orders issued against the salesman who 
may works for customer whose id is 3007.
...
Write a query to count the customers with grades above New Yorks average.
